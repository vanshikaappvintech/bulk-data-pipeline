...
# # ----------------------------
# # 1. DL generators & validators
# # ----------------------------
# # Valid modern DL: starts with "DL" + 13 digits (2-digit RTO, 4-digit year, 7-digit unique)
...
#     # 4-digit year between 1980 and current
...
#     """Validate DL against the modern format (case‐insensitive)."""
#     return bool(DL_REGEX.fullmatch(value.replace(" ", "").replace("-", "")))
...
# def old_format(dl):
#     # change prefix to random state code (invalid)
#     state = random.choice(["MH","KA","TN","UP","GJ"])
#     return state + dl[2:]
# def embedded(dl):        return dl  # wrapped by template
# def alt_label(dl):       return dl  # label in sentence
...
# #    Context keywords: driving license, dl, license number, etc.
# # ----------------------------
# TEMPLATES = {
#     "plain": [
#         "Her driving license number is {v}.",
#         "Please verify DL {v} before issuing a vehicle permit.",
#         "Add license number {v} to the transport records.",
#     ],
#     "lowercase": [
#         "Stored as dl {v}.",
#         "User entered driver's license as {v}.",
#     ],
#     "with_space": [
#         "Enter your license number with space: {v}.",
#         "Motor vehicle license recorded as {v}.",
#     ],
#     "with_dashes": [
#         "The RTO ID appears as {v}.",
#         "Use this license no. {v} for verification.",
#     ],
#     "old_format": [
#         "Old format detected: {v}.",
#         "This appears to be a state DL code: {v}.",
#     ],
#     "embedded": [
#         "DL number is {v}.",
#         "Driver’s license: {v}.",
#     ],
#     "alt_label": [
#         "license card {v} on file.",
#         "transport license number {v}.",
#         "vehicle license ID: {v}.",
#     ],
# }
...
#     print("✅ driving_licenses.json generated with DL variations and real-world sentences.")
