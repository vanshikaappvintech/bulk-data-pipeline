...
#     """Validate uppercase-normalized PAN."""
#     return bool(PAN_REGEX.fullmatch(value.upper()))
...
# def embedded(pan):
#     return pan  # sentence will prepend "PAN: "

# def with_spaces(pan):
#     # split as AB CDE 1234 F
#     return f"{pan[0:2]} {pan[2:5]} {pan[5:9]} {pan[9]}"

# def wrong_format(pan):
#     # shuffle the last five characters to break pattern
#     core = list(pan[5:])
#     random.shuffle(core)
#     return pan[:5] + ''.join(core)

# def with_dash(pan):
#     # dash after first 2 and after next 3, space before final
#     return f"{pan[0:2]}-{pan[2:5]}-{pan[5:9]} {pan[9]}"

# def alt_label(pan):
#     return pan  # template will use labels
...
# TEMPLATES = {
#     "plain": [
#         "Her PAN is {v}, assigned by the Income Tax Department.",
#         "Valid PAN: {v}.",
#     ],
#     "lowercase": [
#         "Lowercase entry: {v}.",
#         "Sometimes recorded as {v}.",
#     ],
#     "mixed_case": [
#         "Mixed-case form: {v}.",
#         "Displayed as {v}.",
...
#     print("✅ pan_numbers.json generated with 20 PAN variations.")
...
# #    Use context terms in natural sentences
# # ----------------------------
# TEMPLATES = {
#     "plain": [
#         "Her Permanent Account Number for tax filing is {v}.",
#         "Please verify PAN {v} with the Income Tax Department.",
#         "E-PAN reference: {v} in your profile.",
#     ],
#     "lowercase": [
#         "We record your pan as {v} in the system.",
#         "User entered permanent account number: {v}.",
#     ],
#     "mixed_case": [
#         "Tax ID entry appears as {v} in the dashboard.",
#         "The taxpayer identification number stored is {v}.",
#     ],
#     "embedded": [
#         "PAN: {v} must match your Aadhaar details.",
#         "Your tax identification number is {v}.",
#     ],
#     "with_spaces": [
...
#     ],
#     "wrong_format": [
#         "The value {v} is not a valid PAN format.",
#         "Please correct your taxpayer id from {v}.",
#     ],
#     "with_dash": [
#         "Some forms show PAN as {v}, please remove dashes.",
#         "Alternate format seen: {v} for e-PAN.",
#     ],
#     "alt_label": [
#         "pan number {v} added to your profile.",
#         "pan id {v} is registered under your name.",
#     ],
# }
...
#     with open("pan_numbers.json", "w", encoding="utf-8") as f:
#         json.dump(out, f, ensure_ascii=False, indent=2)
#     print("✅ pan_numbers.json generated with realistic sentences.")
