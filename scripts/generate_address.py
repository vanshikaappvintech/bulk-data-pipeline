...
# FLAT_PREFIXES = ["Flat", "Apartment", "Block", "Sector"]
...
# # ----------------------------
# def gen_flat_street():
#     flat = f"{random.choice(FLAT_PREFIXES)} {random.randint(1, 500)}"
...
#     return f"{random.randint(1,200)} {street}, {city} - {pin}"
...
#     area = random.choice(AREAS)
#     city = random.choice(CITIES)
#     return f"Resides at {num}/{area}, {city}"

# def is_valid_address(addr):
#     """
#     Heuristic validity:
#      - Contains a 6-digit PIN, or
#      - Starts with Flat/Apartment/Block/Sector and includes a city name.
#     """
#     if PIN_REGEX.search(addr):
#         return True
#     if re.match(r"^(Flat|Apartment|Block|Sector)\b", addr) and any(c in addr for c in CITIES):
#         return True
#     if addr.startswith("Delivered to"):
#         return True
#     return False
...
# # ----------------------------
# # 4. Contextual sentence templates
# # ----------------------------
# TEMPLATES = {
#     "flat_street": [
#         "Her home address is {v}.",
#         "Send the package to her permanent address: {v}.",
#     ],
#     "with_pin": [
#         "Please update your mailing address: {v}.",
#         "I live at {v}.",
#     ],
#     "with_landmark": [
#         "Deliver to: {v}.",
#         "Our delivery address is {v}.",
#     ],
#     "embedded": [
#         "Delivered to: {v}.",
#         "Ship the order to: {v}.",
...
#     print("✅ addresses.json generated with address variations and context‐rich sentences.")
...
#     area   = random.choice(AREAS)
#     city   = random.choice(CITIES)
#     # includes flat, street, area, city
#     return f"{flat}, {street}, {area}, {city}"
...
# # ----------------------------
# # 4. Context-rich sentence templates
# # ----------------------------
# TEMPLATES = {
#     "flat_street": [
#         "Her residential address at {v} includes house number and street details",
#         "Send the package to her home address {v} in the city records",
#         "The address proof shows apartment details at {v}",
#     ],
#     "with_pin": [
#         "Please update your mailing address to {v} with correct pincode",
#         "I entered your billing address as {v} including postal code",
#         "Your current address line is {v} in the district directory",
#     ],
#     "with_landmark": [
#         "Our delivery address is {v} near the neighborhood landmark",
#         "Please verify the office address {v} for shipment",
#         "The colony entrance is located at {v} for delivery purposes",
#     ],
#     "embedded": [
#         "The customer resides at {v} according to address details",
#         "Our records show you live at {v} in your locality",
#         "The delivery address proof lists your location at {v}",
#     ],
#     "alt_terms": [
#         "You have registered your address as {v} under residential address",
#         "Your permanent address is {v} in the city archives",
#         "The contact address registered is {v} in your personal account",
#     ],
# }
...
#     with open("addresses.json", "w", encoding="utf-8") as f:
#         json.dump(out, f, ensure_ascii=False, indent=2)
#     print("✅ addresses.json generated with all context terms included.")
