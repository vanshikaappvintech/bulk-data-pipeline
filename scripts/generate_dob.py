...
# def is_valid_dob(s):
#     """Try parsing against accepted formats."""
...
# # ----------------------------
# def plain(dt):
#     return dt.strftime("%d/%m/%Y")  # 01/01/1990
...
# def iso(dt):
#     return dt.strftime("%Y-%m-%d")  # 1990-01-15

# def words(dt):
#     return dt.strftime("%d %b %Y").lower()  # 01 jan 1990

# def embedded(dt):
#     return dt.strftime("%d/%m/%Y")  # used in sentence

# def alt_label(dt):
#     return dt.strftime("%d-%m-%Y")  # used after label
...
# #    Context: born, dob, date of birth, birthday, etc.
# # ----------------------------
# TEMPLATES = {
#     "plain": [
...
#     ],
#     "with_space": [
#         "My birth date entry shows {v}.",
#         "I entered my date of birth as {v}.",
#     ],
#     "with_dashes": [
#         "My date of birth is {v}.",
...
#     print("✅ dobs.json generated with DOB variations and context-rich sentences.")
